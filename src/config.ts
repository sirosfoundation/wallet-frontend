 ...
 * PAR and token requests). Defaults to false — opt-in until an issuer
 * actually requires or benefits from it. See security/wia-strategy.md
 * ("Tier 3: backend_attested").
 */
