	...
	return (
		<div className="py-2 w-full">
			<div className="flex items-center gap-2 px-2 mb-4">
				...
				<div>
					<p className="font-bold text-lm-gray-900 dark:text-dm-gray-100">
						{prettyDomain(historyItem[0].presentation.audience)}{' '}
					</p>
					<p className="text-sm text-lm-gray-800 dark:text-dm-gray-200">
						{formatDate(historyItem[0].presentation.presentationTimestampSeconds)}
					</p>
				</div>
			</div>
			<div>
			...
			{historyItem[currentSlide - 1] && (
				<div
					className={`pt-5 ${screenType !== 'mobile' ? 'overflow-y-auto items-center custom-scrollbar max-h-[30vh]' : ''} `}
				>
